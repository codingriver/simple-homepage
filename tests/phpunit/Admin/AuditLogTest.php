...
final class AuditLogTest extends TestCase
{
    ...
    public function testAuditLogWritesJsonLine(): void
    {
        ...
        audit_log('settings_save', ['section' => 'general', 'sid' => 's1']);
        ...
        $this->assertSame('settings_save', $data['action']);
