...
const devModeFlagPath = path.resolve(__dirname, '../../../data/.riverops_dev_mode');
...
$_SERVER['SCRIPT_FILENAME'] = '/var/www/riverops/public/login.php';
chdir('/var/www/riverops/public');
include 'login.php';
