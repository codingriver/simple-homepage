...
- 被测站点由 `nav` 服务提供
- Playwright 测试容器定义在 [local/docker-compose.test.yml](/Users/mrwang/project/simple-homepage/local/docker-compose.test.yml)
- 测试容器会自动安装依赖并执行 `npm run playwright:install`
